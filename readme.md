...
| **Procedure** | documentation | No       | No         | No      | Yes      | Yes               |
| **Structure** | documentation | Yes      | Yes        | Yes     | No       | Yes               |
...
<!-- - [QML](https://doc.qt.io/qt-6/qmldocumentation.html) - The `property.subproperty: value` syntax used for grouped properties. -->
...
- [Matt Neuburg's guide on writing TextMate grammar](https://www.apeth.com/nonblog/stories/textmatebundle.html) - A comprehensive documentation for understanding TextMate grammar internals and syntax highlighting behavior. You will have a very hard time dealing with TextMate if you don't digest this guide first.
